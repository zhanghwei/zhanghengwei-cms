		...
		<div class="row offset-1" style="margin-top: 15px;">
			<div class="col-7">
				...
				<div style="margin-top: 10px;margin-bottom: 10px;font-weight: bold;color: #777;">
					...
					<button type="button" class="btn btn-danger" onclick="tousuShow();"></button>
				</div>
					...
					<div class="right">
						...
						<ul class="list-unstyled">
							<c:forEach items="${articleList }" var="item">
								<li class="media">
									<a href="/article/${item.id }.html"><img style="width: 100px; height: 100px;"	src="${item.picture }" class="mr-3" alt=""></a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <div class="form-group">
        <textarea class="form-control" rows="3" id="content1" name="content1"></textarea>
     	</div>
      </div>
